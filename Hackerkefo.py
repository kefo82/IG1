...
[00] Instagram Exit 
	...
	def ua_ran(self):
		...
		rn='Instagram {}.0.0.{}.{} Android ({}/{}; 400dpi; 1080x2175; samsung; SM-S9060; SM-S9060; qcom; en_GB; 472968201)'.format(self.anc,self.apc,self.abc,self.xyz,self.Android_Version(andro),ponid)
